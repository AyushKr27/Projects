...
const SignUpPage = () => {
  ...
  return (
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme="halloween">
      <div className='border borderprimary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden'>
    {/* leftpart */}
...
<div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/create.png" alt="Language connection illustration" className="w-full h-full" />
            </div>
